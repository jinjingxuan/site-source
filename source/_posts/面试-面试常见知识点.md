...
* 浏览器相关
  * 输入 URL 到页面展现的过程
    ...
    * 域名解析ip地址（浏览器缓存 =>  hosts => dns服务器查询 => 本地dns服务器 => 根域名服务器 => 顶级域名服务器 => [二级域名服务器](https://user-gold-cdn.xitu.io/2020/3/7/170b3f53094672ee?imageView2/0/w/1280/h/960/format/webp/ignore-error/1）))
